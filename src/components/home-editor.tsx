...
function HomeEditor() {
    return (
        <div className="w-full relative ">
            <div
                className={cn(
                    "relative backdrop-blur-lg bg-[rgba(43,55,80,0.1)] shadow-xl max-w-screen-2xl mx-auto w-full border border-gray-800 px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start",
            ...
            >
                <JavaEditor />
                <HoverButton className="mx-auto mt-4 flex items-center gap-1">
